...
--
-- Host: localhost
-- Generation Time: Nov 18, 2017 at 11:19 PM
...
CREATE TABLE IF NOT EXISTS `characterline` (
  `CharacterID` int(11) NOT NULL,
...
--
ALTER TABLE `blocking`
  MODIFY `BlockingID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `line`
  MODIFY `LineID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
